...
public final class ExtensionLoader<T> {
    ...
    private static final String BINGHE_DIRECTORY = "META-INF/nya/";
    private static final String BINGHE_DIRECTORY_EXTERNAL = "META-INF/nya/external/";
    private static final String BINGHE_DIRECTORY_INTERNAL = "META-INF/nya/internal/";
